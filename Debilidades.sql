...
/* 1. Integridad de entidad. Aunque la clave primaria está definida, no se utiliza un mecanismo automático (como una secuencia o autoincremento)
 *  para generar los valores de id.
 * 
 * 2. Integridad de atributo. No se valida la estructura del correo electrónico en la columna correo.
 * 
 * 3. Integridad de dominio?. Las fechas de creación deberían ser menores o iguales a la fecha actual para reflejar datos consistentes y 
 * válidos en la lógica de negocio.
 * 
 ...
 * 
 * 7. Integridad de Atributo. La columna nombre debería tener un valor válido y no permitir valores vacíos, ya que es esencial para identificar y
 *  describir el producto.
 * 
 * 8. Integridad de Dominio?. El registro con id 3 tiene un precio de 0, lo cual no es lógico para un producto en venta.
 * 
 * 9. Integridad de Dominio. La descripción de los productos permite valores extremadamente largos (hasta 10,000 caracteres), lo que podría generar
 *  problemas de almacenamiento y rendimiento.
 * 
...
-- XX. Integridad referencial. En la tabla pedido_detalle no establece una restriccion de llave foranea para hacer referencia a los productos.
